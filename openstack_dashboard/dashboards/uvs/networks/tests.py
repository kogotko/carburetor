...
INDEX_URL = reverse('horizon:uvs:networks:index')
...
class NetworkTests(test.BaseAdminViewTests):
    ...
    def test_network_detail_new(self, mac_learning=False):
        ...
        api.neutron.is_extension_supported(
            ...
            'dhcp_agent_scheduler').AndReturn(True)
        self.mox.ReplayAll()
        url = urlunquote(reverse('horizon:uvs:networks:detail',
                                 args=[network_id]))
    ...
    def _test_network_detail_subnets_tab(self, mac_learning=False):
        ...
        api.neutron.is_extension_supported(
            ...
            'dhcp_agent_scheduler').AndReturn(True)
        self.mox.ReplayAll()
        url = urlunquote(reverse('horizon:uvs:networks:subnets_tab',
                         args=[network_id]))
        res = self.client.get(url)
    ...
    def test_network_detail_ports_tab(self, mac_learning=False):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:uvs:networks:ports_tab',
                      args=[network_id])
    ...
    def test_network_detail_agents_tab(self, mac_learning=False):
        ...
        api.neutron.is_extension_supported(
            ...
            'dhcp_agent_scheduler').AndReturn(True)
        self.mox.ReplayAll()
        url = reverse('horizon:uvs:networks:agents_tab', args=[network_id])
        res = self.client.get(urlunquote(url))
    ...
    def test_network_create_get(self,
        ...
        url = reverse('horizon:uvs:networks:create')
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'uvs/networks/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:uvs:networks:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'uvs/networks/update.html')
    ...
    def test_networks_list_with_admin_filter_first(self):
        api.neutron.is_extension_supported(
            ...
            'dhcp_agent_scheduler').AndReturn(True)
        self.mox.ReplayAll()
        res = self.client.get(reverse('horizon:uvs:networks:index'))
        self.assertTemplateUsed(res, INDEX_TEMPLATE)
        networks = res.context['networks_table'].data
