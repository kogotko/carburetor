...
from openstack_dashboard.dashboards.uvs.networks.ports \
...
class CreateView(forms.ModalFormView):
    ...
    submit_url = "horizon:uvs:networks:addport"
    page_title = _("Create Port")
    template_name = 'uvs/networks/ports/create.html'
    url = 'horizon:uvs:networks:detail'
...
class DetailView(project_views.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        port = context["port"]
        network_url = "horizon:uvs:networks:detail"
        subnet_url = "horizon:uvs:networks:subnets:detail"
        ...
        context["url"] = \
            reverse('horizon:uvs:networks:ports_tab', args=[port.network_id])
        context["actions"] = table.render_row_actions(port)
        return context

    @staticmethod
    def get_redirect_url():
        return reverse('horizon:uvs:networks:index')


class UpdateView(project_views.UpdateView):
    form_class = ports_forms.UpdatePort
    template_name = 'uvs/networks/ports/update.html'
    context_object_name = 'port'
    submit_url = "horizon:uvs:networks:editport"
    success_url = 'horizon:uvs:networks:detail'
