...
DETAIL_URL = 'horizon:uvs:networks:ports:detail'

NETWORKS_INDEX_URL = reverse('horizon:uvs:networks:index')
NETWORKS_DETAIL_URL = 'horizon:uvs:networks:detail'
...
class NetworkPortTests(test.BaseAdminViewTests):
    ...
    def _test_port_create_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:uvs:networks:addport',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'uvs/networks/ports/create.html')
    ...
    def _test_port_update_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:uvs:networks:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'uvs/networks/ports/update.html')
