...
from openstack_dashboard.dashboards.uvs.networks.agents import tabs \
    as agents_tabs
from openstack_dashboard.dashboards.uvs.networks \
    import forms as project_forms
from openstack_dashboard.dashboards.uvs.networks.ports \
    import tables as ports_tables
from openstack_dashboard.dashboards.uvs.networks.subnets \
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'uvs/networks/create.html'
    success_url = reverse_lazy('horizon:uvs:networks:index')
    page_title = _("Create Network")


class UpdateView(user_views.UpdateView):
    form_class = project_forms.UpdateNetwork
    template_name = 'uvs/networks/update.html'
    success_url = reverse_lazy('horizon:uvs:networks:index')
    submit_url = "horizon:uvs:networks:update"
...
class DetailView(tabs.TabbedTableView):
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:uvs:networks:index')
