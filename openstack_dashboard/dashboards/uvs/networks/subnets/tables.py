...
class DeleteSubnet(proj_tables.SubnetPolicyTargetMixin, tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        try:
            ...
            redirect = reverse('horizon:uvs:networks:detail',
                               args=[network_id])
...
class CreateSubnet(proj_tables.SubnetPolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:uvs:networks:addsubnet"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateSubnet(proj_tables.SubnetPolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:uvs:networks:editsubnet"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class SubnetsTable(tables.DataTable):
    name = tables.WrappingColumn("name_or_id", verbose_name=_("Name"),
                                 link='horizon:uvs:networks:subnets:detail')
    ...
    failure_url = reverse_lazy('horizon:uvs:networks:index')
