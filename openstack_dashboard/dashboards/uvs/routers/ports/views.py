...
from openstack_dashboard.dashboards.uvs.routers.ports \
...
class AddInterfaceView(forms.ModalFormView):
    ...
    success_url = 'horizon:uvs:routers:detail'
    failure_url = 'horizon:uvs:routers:detail'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['form_url'] = 'horizon:uvs:routers:addinterface'
        return context
...
class SetGatewayView(forms.ModalFormView):
    ...
    success_url = 'horizon:uvs:routers:index'
    failure_url = 'horizon:uvs:routers:index'
