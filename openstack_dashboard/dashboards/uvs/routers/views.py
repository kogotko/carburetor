...
from openstack_dashboard.dashboards.uvs.routers\
    import forms as project_forms
from openstack_dashboard.dashboards.uvs.routers import tables as rtables
from openstack_dashboard.dashboards.uvs.routers import tabs as rdtabs
...
class DetailView(tabs.TabbedTableView):
    ...
    failure_url = reverse_lazy('horizon:uvs:routers:index')
...
class CreateView(forms.ModalFormView):
    ...
    success_url = reverse_lazy("horizon:uvs:routers:index")
    page_title = _("Create Router")
    submit_label = _("Create Router")
    submit_url = reverse_lazy("horizon:uvs:routers:create")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:uvs:routers:update"
