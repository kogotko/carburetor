...
from openstack_dashboard.dashboards.uvs.floating_ips \
...
class DetailView(views.HorizonTemplateView):
    ...
    def _get_corresponding_data(self, resource, resource_id):
        ...
        url = reverse('horizon:uvs:floating_ips:index')
        try:
    ...
    def get_context_data(self, **kwargs):
        ...
        context["url"] = reverse('horizon:uvs:floating_ips:index')
...
class AllocateView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy("horizon:uvs:floating_ips:allocate")
    cancel_url = reverse_lazy('horizon:uvs:floating_ips:index')
    success_url = reverse_lazy('horizon:uvs:floating_ips:index')
