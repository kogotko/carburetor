...
from openstack_dashboard.dashboards.project.floating_ips import tables as project_tables
...
class AdminAllocateFloatingIP(project_tables.AllocateIP):
    url = "horizon:uvs:floating_ips:allocate"

    def single(self, data_table, request, *args):
        return shortcuts.redirect('horizon:uvs:floating_ips:index')
...
class FloatingIPsTable(project_tables.FloatingIPsTable):
    ...
    ip = tables.Column("ip",
                       link=("horizon:uvs:floating_ips:detail"),
