...
INDEX_URL = reverse('horizon:uvs:floating_ips:index')
...
class AdminFloatingIpViewTest(test.BaseAdminViewTests):
    ...
    def test_floating_ip_detail_get(self):
        ...
        res = self.client.get(reverse('horizon:uvs:floating_ips:detail',
                                      args=[fip.id]))
    ...
    def test_admin_allocate_get(self):
        ...
        url = reverse('horizon:uvs:floating_ips:allocate')
