...
from openstack_dashboard.dashboards.uvs.vpn \
    import forms as vpn_forms
from openstack_dashboard.dashboards.uvs.vpn import tables as vpn_tables
from openstack_dashboard.dashboards.uvs.vpn import tabs as vpn_tabs
from openstack_dashboard.dashboards.uvs.vpn \
...
class IKEPolicyDetailsView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:uvs:vpn:index')
...
class UpdateVPNServiceView(forms.ModalFormView):
    ...
    submit_url = "horizon:uvs:vpn:update_vpnservice"
    success_url = reverse_lazy("horizon:uvs:vpn:index")
...
class UpdateIKEPolicyView(forms.ModalFormView):
    ...
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:vpn:update_ikepolicy"
    success_url = reverse_lazy("horizon:uvs:vpn:index")
...
class UpdateIPSecPolicyView(forms.ModalFormView):
    ...
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:vpn:update_ipsecpolicy"
    success_url = reverse_lazy("horizon:uvs:vpn:index")
...
class UpdateIPSecSiteConnectionView(forms.ModalFormView):
    ...
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:vpn:update_ipsecsiteconnection"
    success_url = reverse_lazy("horizon:uvs:vpn:index")
