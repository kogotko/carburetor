...
from openstack_dashboard.dashboards.uvs.firewalls \
...
class RuleDetailsView(tabs.TabView):
    ...
    failure_url = reverse_lazy('horizon:uvs:firewalls:index')
    ...
    def get_context_data(self, **kwargs):
        ...
        breadcrumb = [
            (_("Rules"), reverse_lazy('horizon:uvs:firewalls:rules'))]
...
class PolicyDetailsView(tabs.TabView):
    ...
    def get_context_data(self, **kwargs):
        ...
        breadcrumb = [
            (_("Policies"),
             reverse_lazy('horizon:uvs:firewalls:policies'))]
        context["custom_breadcrumb"] = breadcrumb
...
class UpdateRuleView(forms.ModalFormView):
    ...
    submit_url = "horizon:uvs:firewalls:updaterule"
    success_url = reverse_lazy("horizon:uvs:firewalls:index")
...
class UpdatePolicyView(forms.ModalFormView):
    ...
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:firewalls:updatepolicy"
    success_url = reverse_lazy("horizon:uvs:firewalls:index")
...
class UpdateFirewallView(forms.ModalFormView):
    ...
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:firewalls:updatefirewall"
    success_url = reverse_lazy("horizon:uvs:firewalls:index")
...
class InsertRuleToPolicyView(forms.ModalFormView):
    ...
    context_object_name = 'policy'
    submit_url = "horizon:uvs:firewalls:insertrule"
    submit_label = _("Save Changes")
    success_url = reverse_lazy("horizon:uvs:firewalls:index")
...
class RemoveRuleFromPolicyView(forms.ModalFormView):
    ...
    context_object_name = 'policy'
    submit_label = _("Save Changes")
    submit_url = "horizon:uvs:firewalls:removerule"
    success_url = reverse_lazy("horizon:uvs:firewalls:index")
...
class AddRouterToFirewallView(RouterCommonView):
    ...
    submit_url = "horizon:uvs:firewalls:addrouter"
...
class RemoveRouterFromFirewallView(RouterCommonView):
    ...
    submit_url = "horizon:uvs:firewalls:removerouter"
