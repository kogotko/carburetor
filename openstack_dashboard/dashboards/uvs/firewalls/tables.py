...
class AddRuleLink(tables.LinkAction):
    ...
    url = "horizon:uvs:firewalls:addrule"
    classes = ("ajax-modal",)
    icon = "plus"
...
class AddPolicyLink(tables.LinkAction):
    ...
    url = "horizon:uvs:firewalls:addpolicy"
...
class AddFirewallLink(tables.LinkAction):
    ...
    url = "horizon:uvs:firewalls:addfirewall"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateRuleLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, rule):
        base_url = reverse("horizon:uvs:firewalls:updaterule",
...
class UpdatePolicyLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:uvs:firewalls:updatepolicy",
...
class UpdateFirewallLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:uvs:firewalls:updatefirewall",
...
class InsertRuleToPolicyLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:uvs:firewalls:insertrule",
                           kwargs={'policy_id': policy.id})
        return base_url
...
class RemoveRuleFromPolicyLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, policy):
        base_url = reverse("horizon:uvs:firewalls:removerule",
                           kwargs={'policy_id': policy.id})
        return base_url
...
class AddRouterToFirewallLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:uvs:firewalls:addrouter",
                           kwargs={'firewall_id': firewall.id})
        return base_url
...
class RemoveRouterFromFirewallLink(policy.PolicyTargetMixin,
    ...
    def get_link_url(self, firewall):
        base_url = reverse("horizon:uvs:firewalls:removerouter",
                           kwargs={'firewall_id': firewall.id})
        return base_url
...
def get_policy_link(datum):
    if datum.policy:
        return reverse('horizon:uvs:firewalls:policydetails',
...
class RulesTable(tables.DataTable):
    ...
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:uvs:firewalls:ruledetails")
...
class PoliciesTable(tables.DataTable):
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:uvs:firewalls:policydetails")
    description = tables.Column('description', verbose_name=_('Description'))
...
class FirewallsTable(tables.DataTable):
    ...
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link="horizon:uvs:firewalls:firewalldetails")
    description = tables.Column('description', verbose_name=_('Description'))
    firewall_policy_id = tables.Column(get_policy_name,
                                       link=get_policy_link,
