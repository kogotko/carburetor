...
from openstack_dashboard.dashboards.uvr.volumes.backups \
...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'uvr/volumes/backups/create_backup.html'
    submit_label = _("Create Volume Backup")
    submit_url = "horizon:uvr:volumes:volumes:create_backup"
    success_url = reverse_lazy("horizon:uvr:volumes:backups_tab")
...
class RestoreBackupView(forms.ModalFormView):
    ...
    template_name = 'uvr/volumes/backups/restore_backup.html'
    submit_label = _("Restore Backup to Volume")
    submit_url = "horizon:uvr:volumes:backups:restore"
