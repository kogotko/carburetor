...
from openstack_dashboard.dashboards.uvr.volumes \
...
INDEX_URL = "horizon:uvr:volumes:index"


class CreateView(workflows.WorkflowView):
    workflow_class = vol_cgroup_workflows.CreateCGroupWorkflow
    template_name = 'uvr/volumes/cgroups/create.html'
    page_title = _("Create Volume Consistency Group")


class UpdateView(forms.ModalFormView):
    template_name = 'uvr/volumes/cgroups/update.html'
    page_title = _("Edit Consistency Group")
    form_class = vol_cgroup_forms.UpdateForm
    success_url = reverse_lazy('horizon:uvr:volumes:index')
    submit_url = "horizon:uvr:volumes:cgroups:update"
...
class RemoveVolumesView(forms.ModalFormView):
    template_name = 'uvr/volumes/cgroups/remove_vols.html'
    page_title = _("Remove Volumes from Consistency Group")
    form_class = vol_cgroup_forms.RemoveVolsForm
    success_url = reverse_lazy('horizon:uvr:volumes:index')
    submit_url = "horizon:uvr:volumes:cgroups:remove_volumes"
...
class DeleteView(forms.ModalFormView):
    template_name = 'uvr/volumes/cgroups/delete.html'
    page_title = _("Delete Consistency Group")
    form_class = vol_cgroup_forms.DeleteForm
    success_url = reverse_lazy('horizon:uvr:volumes:index')
    submit_url = "horizon:uvr:volumes:cgroups:delete"
...
class CreateSnapshotView(forms.ModalFormView):
    ...
    template_name = 'uvr/volumes/cgroups/create_snapshot.html'
    submit_label = _("Create Snapshot")
    submit_url = "horizon:uvr:volumes:cgroups:create_snapshot"
    success_url = reverse_lazy('horizon:uvr:volumes:cg_snapshots_tab')
...
class CloneCGroupView(forms.ModalFormView):
    ...
    template_name = 'uvr/volumes/cgroups/clone_cgroup.html'
    submit_label = _("Clone Consistency Group")
    submit_url = "horizon:uvr:volumes:cgroups:clone_cgroup"
    success_url = reverse_lazy('horizon:uvr:volumes:cgroups_tab')
...
class DetailView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse('horizon:uvr:volumes:index')
