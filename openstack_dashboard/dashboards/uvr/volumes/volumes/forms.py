...
from openstack_dashboard.dashboards.uvr.instances import tables
...
class CreateForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            redirect_url = reverse("horizon:uvr:volumes:index")
    ...
    def handle(self, request, data):
        try:
            ...
            redirect = reverse("horizon:uvr:volumes:index")
            exceptions.handle(request,
    ...
    def handle(self, request, data):
        try:
            ...
            response = http.HttpResponseRedirect(
                reverse("horizon:uvr:volumes:volumes:show_transfer",
