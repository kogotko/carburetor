...
from openstack_dashboard.dashboards.uvr.floating_ips import workflows
from openstack_dashboard.dashboards.uvr.instances import tabs
from openstack_dashboard.dashboards.uvr.instances.workflows \
...
class InstancesTable(tables.DataTable):
    ...
    name = tables.WrappingColumn("name",
                                 ...
                                 verbose_name=_("Instance NameUvr"))
