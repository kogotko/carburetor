...
class ManageVolumeAction(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volumes:manage"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UnmanageVolumeAction(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volumes:unmanage"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class MigrateVolume(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volumes:migrate"
...
class UpdateVolumeStatusAction(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volumes:update_status"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume",
...
class VolumesTable(volumes_tables.VolumesTable):
    name = tables.WrappingColumn("name",
                                 verbose_name=_("Name"),
                                 link="horizon:uhd:volumes:volumes:detail")
