...
INDEX_URL = reverse('horizon:uhd:volumes:index')
...
class VolumeTests(test.BaseAdminViewTests):
    ...
    def _test_index(self, instanceless_volumes=False):
        ...
        self.assertTemplateUsed(res, 'uhd/volumes/index.html')
    ...
    def test_volume_types_tab(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:uhd:volumes:volume_types_tab')
        res = self.client.get(urlunquote(url))

        self.assertEqual(res.status_code, 200)
        self.assertTemplateUsed(
            res, 'uhd/volumes/volume_types/volume_types_tables.html')
    ...
    def test_snapshots_tab(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:uhd:volumes:snapshots_tab')
        res = self.client.get(urlunquote(url))
    ...
    def test_snapshots_index_paginated(self):
        ...
        base_url = reverse('horizon:uhd:volumes:snapshots_tab')
