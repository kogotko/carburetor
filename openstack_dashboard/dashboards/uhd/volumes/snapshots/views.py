...
from openstack_dashboard.dashboards.uhd.volumes.snapshots \
...
class UpdateStatusView(forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/snapshots/update_status.html'
    submit_label = _("Update Status")
    submit_url = "horizon:uhd:volumes:snapshots:update_status"
    success_url = reverse_lazy("horizon:uhd:volumes:snapshots_tab")
...
class DetailView(views.DetailView):
    ...
    volume_url = 'horizon:uhd:volumes:volumes:detail'
