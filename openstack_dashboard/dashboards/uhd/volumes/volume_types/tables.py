...
class CreateVolumeType(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:create_type"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditVolumeType(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:update_type"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:types_manage"),)
...
class ViewVolumeTypeExtras(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:extras:index"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:types_manage"),)
...
class ManageQosSpecAssociation(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:manage_qos_spec_association"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:types_manage"),)
...
class DeleteVolumeType(tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        try:
            ...
            redirect_url = reverse("horizon:uhd:volumes:index")
...
class CreateVolumeTypeEncryption(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:create_type_encryption"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateVolumeTypeEncryption(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:update_type_encryption"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:volume_type_encryption"),)
...
def get_volume_type_encryption_link(volume_type):
    if _does_vol_type_enc_exist(volume_type):
        return reverse("horizon:uhd:volumes:volume_types:"
...
class ManageQosSpec(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:qos_specs:index"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:types_manage"),)
...
class CreateQosSpec(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:create_qos_spec"
    classes = ("ajax-modal",)
    icon = "plus"
    policy_rules = (("volume", "volume_extension:types_manage"),)
...
class EditConsumer(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:edit_qos_spec_consumer"
    classes = ("ajax-modal",)
    icon = "pencil"
    policy_rules = (("volume", "volume_extension:types_manage"),)
