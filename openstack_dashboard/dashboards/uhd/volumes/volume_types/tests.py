...
class VolumeTypeTests(test.BaseAdminViewTests):
    ...
    def test_create_volume_type(self):
        ...
        res = self.client.post(
            reverse('horizon:uhd:volumes:volume_types:create_type'),
            formData)
        self.assertNoFormErrors(res)
        redirect = reverse('horizon:uhd:volumes:volume_types_tab')
    ...
    def _test_update_volume_type(self, is_public):
        ...
        url = reverse('horizon:uhd:volumes:volume_types:update_type',
                      args=[volume_type.id])
    ...
    def test_delete_volume_type(self):
        ...
        res = self.client.post(
            reverse('horizon:uhd:volumes:volumes_tab'),
            formData)

        redirect = reverse('horizon:uhd:volumes:volumes_tab')
        self.assertNoFormErrors(res)
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_create_volume_type_encryption(self):
        ...
        url = reverse('horizon:uhd:volumes:'
        ...
        self.assertTemplateUsed(
            res,
            'uhd/volumes/volume_types/create_volume_type_encryption.html')
    ...
    def test_type_encryption_detail_view_unencrypted(self):
        ...
        self.assertTemplateUsed(
            res,
            'uhd/volumes/volume_types/volume_encryption_type_detail.html')
    ...
    def test_delete_volume_type_encryption(self):
        ...
        res = self.client.post(
            reverse('horizon:uhd:volumes:volume_types_tab'),
            formData)
    ...
    def test_update_volume_type_encryption(self):
        ...
        self.assertTemplateUsed(
            res,
            'uhd/volumes/volume_types/update_volume_type_encryption.html')
