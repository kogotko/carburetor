...
from openstack_dashboard.dashboards.uhd.volumes.volume_types.extras \
...
class IndexView(ExtraSpecMixin, forms.ModalFormMixin, tables.DataTableView):
    ...
    template_name = 'uhd/volumes/volume_types/extras/index.html'
...
class CreateView(ExtraSpecMixin, forms.ModalFormView):
    ...
    submit_url = "horizon:uhd:volumes:volume_types:extras:create"
    template_name = 'uhd/volumes/volume_types/extras/create.html'
    success_url = 'horizon:uhd:volumes:volume_types:extras:index'
...
class EditView(ExtraSpecMixin, forms.ModalFormView):
    ...
    submit_label = _("Save")
    submit_url = "horizon:uhd:volumes:volume_types:extras:edit"
    template_name = 'uhd/volumes/volume_types/extras/edit.html'
    success_url = 'horizon:uhd:volumes:volume_types:extras:index'
    cancel_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
