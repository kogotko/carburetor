...
class SpecCreateKeyValuePair(tables.LinkAction):
    ...
    url = "horizon:uhd:volumes:volume_types:qos_specs:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class SpecDeleteKeyValuePair(tables.DeleteAction):
    ...
    def get_success_url(self, request=None):
        return reverse('horizon:uhd:volumes:volume_types_tab')


class SpecEditKeyValuePair(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:uhd:volumes:volume_types:qos_specs:edit"
    classes = ("ajax-modal",)
    icon = "pencil"
