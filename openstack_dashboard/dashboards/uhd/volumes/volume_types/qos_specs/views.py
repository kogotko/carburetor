...
from openstack_dashboard.dashboards.uhd.volumes.volume_types.qos_specs \
...
class IndexView(QosSpecMixin, forms.ModalFormMixin, tables.DataTableView):
    ...
    template_name = 'uhd/volumes/volume_types/qos_specs/index.html'
...
class CreateKeyValuePairView(QosSpecMixin, forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/qos_specs/create.html'
    submit_label = _("Create")
    submit_url = "horizon:uhd:volumes:volume_types:qos_specs:create"
    url = 'horizon:uhd:volumes:volume_types_tab'
...
class EditKeyValuePairView(QosSpecMixin, forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/qos_specs/edit.html'
    submit_label = _("Save")
    submit_url = "horizon:uhd:volumes:volume_types:qos_specs:edit"
    url = 'horizon:uhd:volumes:volume_types_tab'
