...
class QosSpecsTests(test.BaseAdminViewTests):
    ...
    def test_manage_qos_spec(self):
        ...
        index_url = reverse(
            'horizon:uhd:volumes:volume_types:qos_specs:index',
            args=[qos_spec.id])
        ...
        self.assertTemplateUsed(
            res, 'uhd/volumes/volume_types/qos_specs/index.html')
    ...
    def test_create_qos_spec(self):
        ...
        res = self.client.post(
            reverse('horizon:uhd:volumes:volume_types:create_qos_spec'),
            formData)
    ...
    def test_spec_edit(self):
        qos_spec = self.cinder_qos_specs.first()
        key = 'minIOPS'
        edit_url = reverse('horizon:uhd:volumes:volume_types:qos_specs:edit',
                           args=[qos_spec.id, key])
        index_url = reverse('horizon:uhd:volumes:volume_types_tab')
    ...
    def test_edit_consumer(self):
        ...
        edit_url = reverse(
            'horizon:uhd:volumes:volume_types:edit_qos_spec_consumer',
            args=[qos_spec.id])
    ...
    def test_associate_qos_spec(self):
        ...
        edit_url = reverse(
            'horizon:uhd:volumes:volume_types:manage_qos_spec_association',
            args=[volume_type.id])
