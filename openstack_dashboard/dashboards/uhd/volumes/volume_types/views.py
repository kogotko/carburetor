...
from openstack_dashboard.dashboards.uhd.volumes.volume_types \
...
class CreateVolumeTypeView(forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/create_volume_type.html'
    submit_label = _("Create Volume Type")
    submit_url = reverse_lazy("horizon:uhd:volumes:volume_types:create_type")
    success_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
    page_title = _("Create Volume Type")


class VolumeTypeEncryptionDetailView(views.HorizonTemplateView):
    template_name = ("uhd/volumes/volume_types"
    ...
    def get_data(self):
        try:
            ...
            redirect = reverse('horizon:uhd:volumes:index')
...
class CreateVolumeTypeEncryptionView(forms.ModalFormView):
    ...
    submit_url = "horizon:uhd:volumes:volume_types:create_type_encryption"
    success_url = reverse_lazy('horizon:uhd:volumes:index')
...
class EditVolumeTypeView(forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/update_volume_type.html'
    success_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
    cancel_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
    submit_label = _('Edit')
...
def _get_volume_type_name(request, kwargs):
    try:
        ...
        url = reverse('horizon:uhd:volumes:index')
...
class UpdateVolumeTypeEncryptionView(forms.ModalFormView):
    ...
    submit_url = "horizon:uhd:volumes:volume_types:update_type_encryption"
    success_url = reverse_lazy('horizon:uhd:volumes:index')
...
class CreateQosSpecView(forms.ModalFormView):
    ...
    modal_id = "create_volume_type_modal"
    template_name = 'uhd/volumes/volume_types/create_qos_spec.html'
    success_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
    page_title = _("Create QoS Spec")
    submit_label = _("Create")
    submit_url = reverse_lazy(
        "horizon:uhd:volumes:volume_types:create_qos_spec")
...
class EditQosSpecConsumerView(forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/edit_qos_spec_consumer.html'
    submit_label = _("Modify Consumer")
    submit_url = "horizon:uhd:volumes:volume_types:edit_qos_spec_consumer"
    success_url = reverse_lazy('horizon:uhd:volumes:volume_types_tab')
...
class ManageQosSpecAssociationView(forms.ModalFormView):
    ...
    template_name = 'uhd/volumes/volume_types/associate_qos_spec.html'
    submit_label = _("Associate")
    submit_url = "horizon:uhd:volumes:volume_types:"\
