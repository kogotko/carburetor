...
import openstack_dashboard.dashboards.usr.stacks.template_versions.tables \
    as project_tables
import openstack_dashboard.dashboards.usr.stacks.template_versions.tabs \
    as project_tabs


class TemplateVersionsView(tables.DataTableView):
    table_class = project_tables.TemplateVersionsTable
    template_name = 'usr/stacks.template_versions/index.html'
...
class DetailView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse('horizon:usr:stacks.template_versions:index')
