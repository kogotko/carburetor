...
class TemplateVersionsTests(test.TestCase):
    INDEX_URL = reverse('horizon:usr:stacks.template_versions:index')
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(
            res, 'usr/stacks.template_versions/index.html')
    ...
    def test_detail_view(self):
        ...
        url = reverse('horizon:usr:stacks.template_versions:details',
                      args=[t_version])
