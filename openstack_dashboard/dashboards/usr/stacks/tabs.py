...
class StackTopologyTab(tabs.Tab):
    name = _("Topology")
    slug = "topology"
    template_name = "usr/stacks/_detail_topology.html"
    preload = False
...
class StackOverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = "usr/stacks/_detail_overview.html"
...
class ResourceOverviewTab(tabs.Tab):
    ...
    template_name = "usr/stacks/_resource_overview.html"
...
class StackEventsTab(tabs.Tab):
    name = _("Events")
    slug = "events"
    template_name = "usr/stacks/_detail_events.html"
    preload = False
...
class StackResourcesTab(tabs.Tab):
    name = _("Resources")
    slug = "resources"
    template_name = "usr/stacks/_detail_resources.html"
    preload = False
...
class StackTemplateTab(tabs.Tab):
    name = _("Template")
    slug = "stack_template"
    template_name = "usr/stacks/_stack_template.html"
