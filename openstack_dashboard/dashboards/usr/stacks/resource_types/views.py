...
import openstack_dashboard.dashboards.usr.stacks.resource_types.tables \
    as project_tables
import openstack_dashboard.dashboards.usr.stacks.resource_types.tabs \
    as project_tabs
...
class DetailView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse('horizon:usr:stacks.resources:index')
