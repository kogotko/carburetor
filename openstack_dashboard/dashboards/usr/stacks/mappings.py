...
resource_urls = {
    "AWS::AutoScaling::AutoScalingGroup": {
        'link': 'horizon:usr:stacks:detail'},
    "AWS::CloudFormation::Stack": {
        'link': 'horizon:usr:stacks:detail'},
    "AWS::EC2::Instance": {
        'link': 'horizon:usr:instances:detail'},
    "AWS::EC2::InternetGateway": {
        'link': 'horizon:usr:networks:ports:detail'},
    "AWS::EC2::NetworkInterface": {
        'link': 'horizon:usr:networks:ports:detail'},
    "AWS::EC2::RouteTable": {
        'link': 'horizon:usr:routers:detail'},
    "AWS::EC2::SecurityGroup": {
        'link': 'horizon:usr:access_and_security:index'},
    "AWS::EC2::Subnet": {
        'link': 'horizon:usr:networks:subnets:detail'},
    "AWS::EC2::Volume": {
        'link': 'horizon:usr:volumes:volumes:detail'},
    "AWS::EC2::VPC": {
        'link': 'horizon:usr:networks:detail'},
    "AWS::S3::Bucket": {
        'link': 'horizon:usr:containers:index'},
    "OS::Cinder::Volume": {
        'link': 'horizon:usr:volumes:volumes:detail'},
    ...
    "OS::Heat::CloudConfig": {
        'link': 'horizon:usr:stacks:detail'},
    "OS::Neutron::Firewall": {
        'link': 'horizon:usr:firewalls:firewalldetails'},
    "OS::Neutron::FirewallPolicy": {
        'link': 'horizon:usr:firewalls:policydetails'},
    "OS::Neutron::FirewallRule": {
        'link': 'horizon:usr:firewalls:ruledetails'},
    "OS::Heat::HARestarter": {
        'link': 'horizon:usr:stacks:detail'},
    ...
    "OS::Neutron::IKEPolicy": {
        'link': 'horizon:usr:vpn:ikepolicydetails'},
    "OS::Neutron::IPsecPolicy": {
        'link': 'horizon:usr:vpn:ipsecpolicydetails'},
    "OS::Neutron::IPsecSiteConnection": {
        'link': 'horizon:usr:vpn:ipsecsiteconnectiondetails'},
    "OS::Neutron::Net": {
        'link': 'horizon:usr:networks:detail'},
    "OS::Neutron::Port": {
        'link': 'horizon:usr:networks:ports:detail'},
    ...
    "OS::Neutron::VPNService": {
        'link': 'horizon:usr:vpn:vpnservicedetails'},
    "OS::Nova::KeyPair": {
        'link': 'horizon:usr:access_and_security:index'},
    "OS::Nova::Server": {
        'link': 'horizon:usr:instances:detail'},
