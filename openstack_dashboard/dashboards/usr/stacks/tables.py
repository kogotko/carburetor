...
class LaunchStack(tables.LinkAction):
    ...
    url = "horizon:usr:stacks:select_template"
    classes = ("ajax-modal",)
    icon = "plus"
...
class PreviewStack(tables.LinkAction):
    ...
    url = "horizon:usr:stacks:preview_template"
    classes = ("ajax-modal",)
    icon = "eye"
    policy_rules = (("orchestration", "stacks:validate_template"),
...
class ChangeStackTemplate(tables.LinkAction):
    ...
    url = "horizon:usr:stacks:change_template"
    classes = ("ajax-modal",)
    icon = "pencil"
...
def get_resource_url(obj):
    if obj.physical_resource_id == obj.stack_id:
        return None
    return urlresolvers.reverse('horizon:usr:stacks:resource',
