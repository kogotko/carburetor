...
from openstack_dashboard.dashboards.usr.stacks import api as project_api
from openstack_dashboard.dashboards.usr.stacks import forms
from openstack_dashboard.dashboards.usr.stacks import mappings
from openstack_dashboard.dashboards.usr.stacks import tables


INDEX_TEMPLATE = 'horizon/common/_data_table_view.html'
INDEX_URL = reverse('horizon:usr:stacks:index')
DETAIL_URL = 'horizon:usr:stacks:detail'
...
class MappingsTests(test.TestCase):
    ...
    def test_mappings(self):
        ...
        assertMappingUrl(
            '/usr/networks/subnets/aaa/detail',
            'OS::Neutron::Subnet',
            'aaa')
        assertMappingUrl(
            None,
...
class StackTests(test.TestCase):
    ...
    def test_index_paginated(self):
        ...
        url = reverse('horizon:usr:stacks:index')
        ...
        url = "%s?%s=%s" % (reverse('horizon:usr:stacks:index'),
    ...
    def test_launch_stack(self):
        ...
        url = reverse('horizon:usr:stacks:select_template')
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'usr/stacks/select_template.html')

        form_data = {'template_source': 'raw',
                     'template_data': template.data,
                     'method': forms.TemplateForm.__name__}
        res = self.client.post(url, form_data)
        self.assertTemplateUsed(res, 'usr/stacks/create.html')

        url = reverse('horizon:usr:stacks:launch')
        form_data = {'template_source': 'raw',
                     'template_data': template.data,
                     'password': 'password',
    ...
    def test_edit_stack_template(self):
        ...
        url = reverse('horizon:usr:stacks:change_template',
                      args=[stack.id])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'usr/stacks/change_template.html')
        ...
        url = reverse('horizon:usr:stacks:edit_stack',
                      args=[stack.id, ])
        form_data = {'template_source': 'raw',
                     'template_data': template.data,
                     'password': 'password',
    ...
    def test_preview_stack(self):
        ...
        url = reverse('horizon:usr:stacks:preview_template')
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'usr/stacks/preview_template.html')

        form_data = {'template_source': 'raw',
                     'template_data': template.data,
                     'method': forms.PreviewTemplateForm.__name__}
        res = self.client.post(url, form_data)
        self.assertTemplateUsed(res, 'usr/stacks/preview.html')

        url = reverse('horizon:usr:stacks:preview')
        form_data = {'template_source': 'raw',
                     'template_data': template.data,
                     'parameters': template.validate,
                     'stack_name': stack.stack_name,
        ...
        res = self.client.post(url, form_data)
        self.assertTemplateUsed(res, 'usr/stacks/preview_details.html')
    ...
    def test_detail_stack_topology(self):
        ...
        self.assertEqual(tab.template_name,
                         'usr/stacks/_detail_topology.html')
    ...
    def test_detail_stack_overview(self):
        ...
        self.assertEqual(tab.template_name,
                         'usr/stacks/_detail_overview.html')
    ...
    def test_detail_stack_resources(self):
        ...
        self.assertEqual(tab.template_name,
                         'usr/stacks/_detail_resources.html')
    ...
    def test_detail_stack_template(self):
        ...
        self.assertEqual(tab.template_name,
                         'usr/stacks/_stack_template.html')
    ...
    def test_resource_view(self):
        ...
        url = reverse('horizon:usr:stacks:resource',
                      args=[stack.id, resource.resource_name])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'horizon/common/_detail.html')
        self.assertTemplateUsed(res, 'usr/stacks/_resource_overview.html')
