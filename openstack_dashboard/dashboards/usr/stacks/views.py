...
from openstack_dashboard.dashboards.usr.stacks \
...
class SelectTemplateView(forms.ModalFormView):
    template_name = 'usr/stacks/select_template.html'
    form_id = "select_template"
    form_class = project_forms.TemplateForm
    submit_label = _("Next")
    submit_url = reverse_lazy("horizon:usr:stacks:select_template")
    success_url = reverse_lazy('horizon:usr:stacks:launch')
...
class ChangeTemplateView(forms.ModalFormView):
    template_name = 'usr/stacks/change_template.html'
    form_id = "change_template"
    form_class = project_forms.ChangeTemplateForm
    submit_label = _("Next")
    submit_url = "horizon:usr:stacks:change_template"
    cancel_url = reverse_lazy('horizon:usr:stacks:index')
    success_url = reverse_lazy('horizon:usr:stacks:edit_stack')
    ...
    def get_object(self):
        ...
        try:
            ...
            redirect = reverse('horizon:usr:stacks:index')
...
class PreviewTemplateView(forms.ModalFormView):
    template_name = 'usr/stacks/preview_template.html'
    form_id = "preview_template"
    form_class = project_forms.PreviewTemplateForm
    submit_label = _("Next")
    submit_url = reverse_lazy('horizon:usr:stacks:preview_template')
    success_url = reverse_lazy('horizon:usr:stacks:preview')
...
class CreateStackView(forms.ModalFormView):
    template_name = 'usr/stacks/create.html'
    form_id = "launch_stack"
    form_class = project_forms.CreateStackForm
    submit_label = _("Launch")
    submit_url = reverse_lazy("horizon:usr:stacks:launch")
    success_url = reverse_lazy('horizon:usr:stacks:index')
...
class EditStackView(CreateStackView):
    template_name = 'usr/stacks/update.html'
    form_id = "update_stack"
    form_class = project_forms.EditStackForm
    submit_label = _("Update")
    submit_url = "horizon:usr:stacks:edit_stack"
    success_url = reverse_lazy('horizon:usr:stacks:index')
...
class PreviewStackView(CreateStackView):
    template_name = 'usr/stacks/preview.html'
    form_id = "preview_stack"
    form_class = project_forms.PreviewStackForm
    submit_label = _("Preview")
    submit_url = reverse_lazy('horizon:usr:stacks:preview')
    success_url = reverse_lazy('horizon:usr:stacks:index')
...
class PreviewStackDetailsView(forms.ModalFormMixin, views.HorizonTemplateView):
    template_name = 'usr/stacks/preview_details.html'
...
class DetailView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse('horizon:usr:stacks:index')
